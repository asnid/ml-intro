...
df.drop(['id'], 1, inplace = True) 	# If this isn't dropped, classifier fails miserably (see by commenting this out) - k-nearest neighbours fails if given useless data
